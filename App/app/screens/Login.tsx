...
export default function Login() {
  ...
  function login() {
    ...
    if (cpf == "50283004886" && senha == "243002") {
      router.push("/screens/interface/Interface");
    } else {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.loginTitle}>
        <Text style={styles.t1}>TREVO</Text>

        <Text style={styles.mensagem}>Sua Conta Digital</Text>
      </View>

      {abrir ? (
        <View style={styles.loginEnv}>
          <TextInput
      ...
      <View style={styles.btnContainer}>
        <TouchableOpacity style={styles.btnLogin} onPress={login}>
          <Text style={styles.tbtn1}>Entrar</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.btnCadastro} onPress={Cadastro}>
          <Text style={styles.tbtn2}>Fazer Cadastro</Text>
        </TouchableOpacity>
        ...
        <View style={styles.baixo}>
          <View style={styles.seguranca}>
            ...
            />
            <Text style={styles.secu}>Segurança</Text>
          </View>

          <Text style={styles.secur}>Sobre</Text>
        </View>
      </View>
    </View>
  );
