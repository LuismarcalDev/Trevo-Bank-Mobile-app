...
export default function CadastroTl2() {
  ...
  return (
    <View style={styles.cadastro}>
      <Text style={styles.title}>Tenha mais Segurança com a Trevobank</Text>

      <View style={styles.geral}>
        <View style={styles.containerInput}>
          <Text style={styles.label}>CPF</Text>

          <TextInput placeholder="XXX-XXX-XXX-XX" style={styles.input} />
        </View>

        <View style={styles.containerInput}>
          <Text style={styles.label}>Data De Nascimento</Text>

          <TextInput placeholder="DD/MM/AA" style={styles.input} />
        </View>
        ...
        <TouchableOpacity onPress={pt3} style={styles.btn}>
